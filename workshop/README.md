...
1. **Create your FanHub repository** from the template:
   - Visit [github.com/rbmathis/FanHub](https://github.com/rbmathis/FanHub)
...
A: All setup instructions are in the [FanHub repository](https://github.com/rbmathis/FanHub). Create your repo from the template and follow the README there.
