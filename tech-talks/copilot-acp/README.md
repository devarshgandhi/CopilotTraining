...
The [**ACP Agent Orchestrator**](https://github.com/rbmathis/cli-acp) takes the polyrepo use case above and turns it into a production-ready tool with an **orchestrator + worker architecture**, **broadcast prompts**, and **automatic synthesis** of cross-repo results.
...
- [ ] Clone and run the [ACP Agent Orchestrator](https://github.com/rbmathis/cli-acp) to see multi-agent orchestration in action
