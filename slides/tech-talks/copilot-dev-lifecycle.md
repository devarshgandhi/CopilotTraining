...
<div class="mt-8 text-lg opacity-70 relative z-10">Copilot at every phase — not just code completion</div>
...
<div class="text-sm text-gray-300">Most teams only use autocomplete</div>
</div>
...
<div class="text-sm text-gray-300">Plan → Code → Review → Automate</div>
</div>
...
<div class="text-sm text-gray-300">Repos improve while you sleep</div>
</div>
</div>
</div>
</div>
...
<div class="text-sm text-gray-300 mt-1">Plan Mode, @workspace, MCP</div>
<div class="text-xs text-gray-400 mt-2">Understand before you code</div>
</div>
...
<div class="text-sm text-gray-300 mt-1">CCA, session logs, iteration</div>
<div class="text-xs text-gray-400 mt-2">Agentic implementation</div>
</div>
...
<div class="text-sm text-gray-300 mt-1">CCR, PR summaries, compliance</div>
<div class="text-xs text-gray-400 mt-2">Automated quality gates</div>
</div>
</div>
...
<div class="text-sm text-gray-300 mt-1">Continuous AI & Agent Factory</div>
<div class="text-xs text-gray-400 mt-2">Autonomous repo maintenance</div>
</div>
...
<div class="text-sm text-gray-300 mt-1">Cross-agent learning</div>
<div class="text-xs text-gray-400 mt-2">Agents that remember</div>
</div>
</div>
...
<div class="text-gray-300">Most teams stop at inline suggestions — leaving 80% of AI capability untouched</div>
<div><strong>Pre-coding is still manual</strong></div>
<div class="text-gray-300">Hours reading code, writing plans, and researching approaches before a single line</div>
</div>
</div>
...
<div class="text-gray-300">PR reviews, quality enforcement, and docs rely on separate tools and manual checklists</div>
<div><strong>Maintenance doesn't scale</strong></div>
<div class="text-gray-300">Issue triage, test gaps, stale docs accumulate faster than teams can address them</div>
</div>
</div>
</div>
...
<div class="text-xs text-gray-300">@workspace analysis, CCA Plan Mode, MCP servers, session logs for persistent context</div>
</div>
...
<div class="text-xs text-gray-300">CCA agentic builder, multi-step execution, session-log iteration, PR/no-PR workflows</div>
</div>
...
<div class="text-xs text-gray-300">Copilot Code Review, PR summaries, compliance via repo instructions, CI/CD integration</div>
</div>
</div>
<div class="space-y-3">
...
<div class="text-xs text-gray-300">Agentic Workflows in Actions — triage, docs, tests, security scanning, all autonomous</div>
</div>
...
<div class="text-xs text-gray-300">What coding agent learns helps code review, CLI, and future sessions automatically</div>
</div>
</div>
</div>
...
<div class="text-xs font-mono bg-gray-800 p-2 rounded text-gray-300">
@workspace How is auth implemented?<br/>
@workspace What files for a new endpoint?<br/>
@workspace Show data flow to DB layer
</div>
<div class="text-xs text-gray-400 mt-2">Replaces "read code for 2 hours" — saves 30-60 min/feature</div>
</div>
<div class="p-3 bg-blue-900/40 rounded-lg border-l-4 border-blue-500">
...
<div class="text-xs text-gray-400 mt-2">Structured plans → session logs → persistent context across sessions</div>
</div>
</div>
<div class="space-y-3">
<div class="p-3 bg-indigo-900/40 rounded-lg border-l-4 border-indigo-500">
<div class="text-sm font-bold text-indigo-300 mb-2">🔗 MCP + Domain Context</div>
<div class="text-xs text-gray-300">MCP servers add domain-specific context — databases, APIs, design systems — to planning phase</div>
</div>
<div class="p-3 bg-purple-900/40 rounded-lg border-l-4 border-purple-500">
<div class="text-sm font-bold text-purple-300 mb-2">📝 Session Logs</div>
<div class="text-xs text-gray-300">Persistent artifacts bridging planning and coding. Decisions, context, and todos survive between sessions.</div>
</div>
</div>
</div>
...
<td class="p-3 text-gray-300">Inline Completions</td>
<td class="p-3 text-gray-400">Developer-driven</td>
<td class="p-3 text-gray-400">Small edits, boilerplate</td>
</tr>
<tr class="bg-blue-900/20">
<td class="p-3 text-gray-300">Copilot Chat</td>
<td class="p-3 text-gray-400">Conversational</td>
<td class="p-3 text-gray-400">Exploration, debugging</td>
</tr>
<tr class="bg-indigo-900/20">
<td class="p-3 text-gray-300">Copilot Edits</td>
<td class="p-3 text-gray-400">Multi-file</td>
<td class="p-3 text-gray-400">Refactoring, features</td>
</tr>
<tr class="bg-purple-900/20">
<td class="p-3 text-gray-300">CCA (Coding Agent)</td>
<td class="p-3 text-gray-400">Autonomous</td>
<td class="p-3 text-gray-400">Multi-step tasks, full features</td>
</tr>
</tbody>
</table>
</div>
...
<div class="text-xs text-gray-400 mt-2">Iterative loops produce 2-3× better outcomes than one-shot prompts</div>
</div>
...
<div class="text-xs text-gray-300">Auto-generated structured descriptions + file-by-file change walkthroughs. Reduces reviewer ramp-up by 50-70%.</div>
</div>
</div>
<div class="space-y-3">
<div class="p-3 bg-indigo-900/40 rounded-lg border-l-4 border-indigo-500">
...
<div class="text-xs text-gray-400 mt-2">Respected by Chat, CCA, and CCR — consistent quality bar</div>
</div>
<div class="p-3 bg-purple-900/40 rounded-lg border-l-4 border-purple-500">
<div class="text-sm font-bold text-purple-300 mb-2">⚙️ DevOps Integration</div>
<div class="text-xs text-gray-300">CCA understands Actions workflows, explains CI failures, generates new pipelines from natural language</div>
</div>
</div>
</div>
...
<div class="text-xs text-gray-400 mt-2">Frontmatter = triggers + security. Body = natural language intent.</div>
</div>
</div>
<div class="space-y-3">
<div class="p-3 bg-pink-900/40 rounded-lg border-l-4 border-pink-500">
...
<div class="text-xs text-gray-400 mt-2">100+ workflows in production</div>
</div>
<div class="p-3 bg-blue-900/40 rounded-lg border-l-4 border-blue-500">
<div class="text-sm font-bold text-blue-300 mb-2">🔒 Defense-in-Depth</div>
<div class="text-xs text-gray-300">Read-only default → Safe Outputs buffer all writes → humans review before merge</div>
</div>
</div>
</div>
...
<div class="text-xs text-gray-300">Agents capture tightly scoped memories with citations to specific code locations. Before using a memory, agents verify citations in real time against the current branch.</div>
</div>
<div class="p-3 bg-blue-900/40 rounded-lg border-l-4 border-blue-500">
<div class="text-sm font-bold text-blue-300 mb-2">🔄 Cross-Agent Sharing</div>
<div class="text-xs text-gray-300">What coding agent learns → helps code review catch inconsistencies → helps CLI navigate logs. Knowledge transfers automatically.</div>
</div>
</div>
<div class="space-y-3">
<div class="p-3 bg-indigo-900/40 rounded-lg border-l-4 border-indigo-500">
<div class="text-sm font-bold text-indigo-300 mb-2">🔧 Self-Healing</div>
<div class="text-xs text-gray-300">Code changes invalidate a memory → agents detect contradiction → store corrected version. Auto-expire after 28 days.</div>
</div>
<div class="p-3 bg-purple-900/40 rounded-lg border-l-4 border-purple-500">
